package com.adundar.messageservice.utils;
...
public class Utils {
    ...
    public static final String MESSAGE_ID_NOT_FOUND          = "Message not found. MessageId: ''{0}''";
    ...
    public static String getMessageIdNotFoundError(String messageId) {
        return MessageFormat.format(MESSAGE_ID_NOT_FOUND, messageId);
    }
